...
public readonly struct PtrConvert<T, T2>(Memory<T> elements) where T : struct where T2 : struct
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PtrConvert<T, T2> operator -(PtrConvert<T, T2> left, int offset)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PtrConvert<T, T2>(Ptr<T> left)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PtrConvert<T, T2> operator +(PtrConvert<T, T2> left, uint offset)
    {
        return new PtrConvert<T, T2>(left.elements.Slice((int)offset * Marshal.SizeOf<T2>()));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static PtrConvert<T, T2> operator ++(PtrConvert<T, T2> left)
    {
        return new PtrConvert<T, T2>(left.elements.Slice(1 * Marshal.SizeOf<T2>()));
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PtrConvert<T, T2>(Memory<T> left)
    {
        return new PtrConvert<T, T2>(left);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator PtrConvert<T, T2>(T[] left)
    {
        return new PtrConvert<T, T2>(left);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator Span<T2>(PtrConvert<T, T2> left)
    {
        return left.Span;
    }

    public static readonly PtrConvert<T, T2> Null = new(Memory<T>.Empty);
