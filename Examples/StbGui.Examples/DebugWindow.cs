...
public static class DebugWindow
{
    public static void Render(StbGuiAppBase appBase, StbGuiStringMemoryPool mp)
    {
        ...
        StbGui.stbg_label(mp.Build("Hash time time     : ").Append(metrics.average_performance_metrics.hash_time_us / 1000.0f, 3) + " ms" + (StbGui.stbg_get_context().init_options.force_always_render ? " [always render]" : ""));
