...
public static class DebugWindow
{
    public static void Render(StbGuiAppBase appBase, StbGuiStringMemoryPool mp)
    {
        ...
        var frame_stats = StbGui.stbg_get_frame_stats();
        ...
        StbGui.stbg_label(mp.Build("SMP Used Characters: ") + frame_stats.string_memory_pool_used_characters + " Wasted: " + frame_stats.custom_properties_memory_pool_wasted_alignment_bytes + " Overflown: " + frame_stats.string_memory_pool_overflowed_characters);
        StbGui.stbg_label(mp.Build("CMP Used Bytes: ") + frame_stats.custom_properties_memory_pool_used_bytes + " Overflown: " + frame_stats.custom_properties_memory_pool_overflowed_bytes);
